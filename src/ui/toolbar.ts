...
import { toggleModelPanel } from "./model-panel";
...
const ICONS: Record<string, string> = {
  ...
  models: `<svg viewBox="0 0 20 20" fill="currentColor" width="20" height="20"><path d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"/></svg>`,
